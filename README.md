...
This repo incorporates assets, code, or ideas, in full or in part, from the following open source projects:

- https://github.com/osmus/OpenTrailMap ([MIT](https://github.com/osmus/OpenTrailMap/blob/main/LICENSE))
- https://github.com/openstreetmap/iD ([ISC](https://github.com/openstreetmap/iD/blob/develop/LICENSE.md))
